...
8. Leave changes uncommitted unless the user explicitly asks to commit.
...
This mode is common for gate scorecards, artifact maps, master batons, historical architecture folders, and other Atlas continuity anchors after a no-live evidence/gap review.
